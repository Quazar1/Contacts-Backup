...
public class ManageContactsActivity extends TabActivity {
    ...
    private static final String PACKAGE_NAME = ManageContactsActivity.class.getPackage().getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tab_phone").setIndicator(getString(R.string.phone_tab_title),res.getDrawable(android.R.drawable.sym_action_call)).setContent(R.id.phoneview));
        mTabHost.addTab(mTabHost.newTabSpec("tab_simcard").setIndicator(getString(R.string.sim_tab_title),res.getDrawable(R.drawable.simcard36)).setContent(R.id.simview));

        // start with phone tab
        mTabHost.setCurrentTab(0);

        mdialog = ProgressDialog.show(ManageContactsActivity.this, "", "Loading", true);

        hdrUpdating = new Handler() {
        ...
        Thread checkUpdate = new Thread() {
            public void run() {
                ...
                hdrUpdating.sendEmptyMessage(0);
            }
        };
    ...
    public boolean onContextItemSelected(MenuItem aItem) {
        ...
        case COPY_PHONE_CONTACT:
            ...
            if (newSimRow == null) {
                ...
                Toast.makeText(ManageContactsActivity.this, getString(R.string.confirm_sim_contact_stored) , Toast.LENGTH_SHORT)
                .show();
            }
